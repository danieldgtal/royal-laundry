                        ...
                        <div class="row">
                            ...
                            <div class="form-group col-6">
                                ...
                                <div>
                                    ...
                                    <?php $__errorArgs = ['updated_amount'];
$__bag = $errors->getBag($__errorArgs[1] ?? 'default');
if ($__bag->has($__errorArgs[0])) :
if (isset($message)) { $__messageOriginal = $message; }
$message = $__bag->first($__errorArgs[0]); ?>
...
unset($__errorArgs, $__bag); ?>
                    ...
                    <div class="col-sm-12 col-md-4">
                        ...
                        <div class="dt-buttons btn-group">
                            <a href="<?php echo e(route('export_invoices_pdf')); ?>" target="_blank" type="button"
                                class="btn btn-secondary buttons-pdf buttons-html5" tabindex="0"
                                type="button"><span>PDF</span>
                            </a>
                            <a href="<?php echo e(route('export_invoices_excel')); ?>" target="_blank" type="button"
                                class="btn btn-secondary buttons-pdf buttons-html5" tabindex="0"
                                                ...
                                                <div class="dropdown">
                                                    ...
                                                    <div class="dropdown-menu" aria-labelledby="dropdownMenuButton">
                                                        <a class="dropdown-item" href="#"
                                                            wire:click.prevent="invoiceView(<?php echo e($invoice->invoice_id); ?>)">Print
                                                            Invoice</a>
                                                        <a class="dropdown-item" href="#"
                                                            wire:click.prevent="editInvoice(<?php echo e($invoice->invoice_id); ?>)">Edit
                                                            Invoice</a>
                                                    </div>
                                                </div>
                                            </td>
...
<?php $__env->stopPush(); ?>
<?php /**PATH C:\xampp\htdocs\royalchoicelaundry\resources\views/livewire/staff/invoices.blade.php ENDPATH**/ ?>