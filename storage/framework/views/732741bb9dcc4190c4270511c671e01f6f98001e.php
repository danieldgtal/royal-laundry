...
<?php endif; ?>
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('staff.create-item', [])->html();
} elseif ($_instance->childHasBeenRendered('IvUewzW')) {
    $componentId = $_instance->getRenderedChildComponentId('IvUewzW');
    $componentTag = $_instance->getRenderedChildComponentTagName('IvUewzW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('IvUewzW');
} else {
    $response = \Livewire\Livewire::mount('staff.create-item', []);
    $html = $response->html();
    $_instance->logRenderedChild('IvUewzW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\royalchoicelaundry\resources\views/staff/items.blade.php ENDPATH**/ ?>