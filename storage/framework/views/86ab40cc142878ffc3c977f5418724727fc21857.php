...
<?php endif; ?>
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('admin.invoices', [])->html();
} elseif ($_instance->childHasBeenRendered('l2eixJW')) {
    $componentId = $_instance->getRenderedChildComponentId('l2eixJW');
    $componentTag = $_instance->getRenderedChildComponentTagName('l2eixJW');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('l2eixJW');
} else {
    $response = \Livewire\Livewire::mount('admin.invoices', []);
    $html = $response->html();
    $_instance->logRenderedChild('l2eixJW', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\royalchoicelaundry\resources\views/admin/invoices.blade.php ENDPATH**/ ?>