<footer class="site-footer">
    <div class="site-footer-shape wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms"
        style="background-image: url(home/assets/images/shapes/site-footer-shape.png);">
    </div>
                ...
                <div class="col-xl-3 col-lg-6 col-md-6 wow fadeInUp" data-wow-delay="100ms">
                    <div class="footer-widget__column footer-widget__about">
                        <div class="footer-widget__logo">
                            <a href="<?php echo e(route('home.index')); ?>"><img src="home/assets/images/resources/logo-2.png"
                                    alt=""></a>
                        </div>
            ...
            <div class="row">
                <div class="col-xl-12">
                    <div class="site-footer__bottom-inner">
                        <p class="site-footer__bottom-text">© Copyright 2023 <a href="#">Royal Choice
                                Laundry</a>
                        </p>
...
<?php /**PATH C:\xampp\htdocs\royalchoicelaundry\resources\views/home/partials/footer.blade.php ENDPATH**/ ?>