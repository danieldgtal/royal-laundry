...
<?php endif; ?>
        ...
        <?php
if (! isset($_instance)) {
    $html = \Livewire\Livewire::mount('staff.invoices', [])->html();
} elseif ($_instance->childHasBeenRendered('dO8P188')) {
    $componentId = $_instance->getRenderedChildComponentId('dO8P188');
    $componentTag = $_instance->getRenderedChildComponentTagName('dO8P188');
    $html = \Livewire\Livewire::dummyMount($componentId, $componentTag);
    $_instance->preserveRenderedChild('dO8P188');
} else {
    $response = \Livewire\Livewire::mount('staff.invoices', []);
    $html = $response->html();
    $_instance->logRenderedChild('dO8P188', $response->id(), \Livewire\Livewire::getRootElementTagName($html));
}
echo $html;
?>
    </div>
...
<?php echo $__env->make('layouts.app', \Illuminate\Support\Arr::except(get_defined_vars(), ['__data', '__path']))->render(); ?><?php /**PATH C:\xampp\htdocs\royalchoicelaundry\resources\views/staff/invoices.blade.php ENDPATH**/ ?>