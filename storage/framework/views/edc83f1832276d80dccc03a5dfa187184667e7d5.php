<section class="how-we-work">
    <div class="how-we-work-shape wow slideInLeft" data-wow-delay="100ms" data-wow-duration="2500ms"
        style="background-image: url(home/assets/images/shapes/how-we-work-shape.png);"></div>
    <div class="container">
        ...
        <ul class="list-unstyled how-we-work__list">
            <li class="how-we-work__single">
                <div class="how-we-work__single-box">
                    ...
                    <p class="how-we-work__text">Dirty clothes weighing you down? Let us pick up the load and lighten
                        your load!</p>
                </div>
            </li>
            <li class="how-we-work__single">
                <div class="how-we-work__single-box">
                    ...
                    <p class="how-we-work__text">Handling your services with professional touches from start to finish.
                    </p>
                </div>
            </li>
            <li class="how-we-work__single">
                <div class="how-we-work__single-box">
                    ...
                    <p class="how-we-work__text">Properly Packaged Clothes ready for Pickup or Delivery.</p>
                </div>
            </li>
        </ul>
        <div class="how-we-work__bottom">
            <a href="<?php echo e(route('login')); ?>" class="thm-btn how-we-work__btn">Book Our Services Now <span
                    class="icon-right-arrow"></span></a>
        </div>
    </div>
</section>
<?php /**PATH C:\xampp\htdocs\royalchoicelaundry\resources\views/home/partials/how-we-work.blade.php ENDPATH**/ ?>